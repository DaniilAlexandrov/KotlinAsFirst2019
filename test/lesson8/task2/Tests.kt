...
class Tests {
    ...
    fun bishopTrajectory() {
        assertEquals(listOf(square("c2"), square("e4"), square("a8")), bishopTrajectory(square("c2"), square("a8")))
        assertEquals(listOf(square("a6"), square("e2"), square("d1")), bishopTrajectory(square("a6"), square("d1")))
        ...
        assertEquals(listOf(square("a4"), square("c2"), square("b1")), bishopTrajectory(square("a4"), square("b1")))
